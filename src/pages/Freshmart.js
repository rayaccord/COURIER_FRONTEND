...
// Import images
import fresmartImg from "../assets/fresmart.jpg";
import fresmart1 from "../assets/fresmart1.jpg";
import fresmart2 from "../assets/fresmart2.jpg";
import fresmart3 from "../assets/fresmart3.jpg";
...
const FreshMart = () => {
  ...
  const [restaurantItems] = useState([
    { id: 1, name: "Groundnut oil", desc: "Groundnut oil", price: 75, img: fresmart1, category: "groundnut oil" },
    { id: 2, name: "Red oil", desc: "Red oil", price: 75, img: fresmart2, category: "red oil" },
    { id: 3, name: "Groundnut oil", desc: "Groundnut oil", price: 75, img: fresmart3, category: "groundnut oil" },
    { id: 4, name: "Groundnut oil", desc: "Groundnut oil", price: 75, img: fresmart1, category: "groundnut oil" },
    { id: 5, name: "Red oil", desc: "Red oil", price: 75, img: fresmart2, category: "red oil" },
  ]);
  ...
  const categories = ["all", "groundnut oil", "red oil"];
  ...
  return (
    <>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; font-family:"Inter",Arial,sans-serif; }
        ...
        header {
          ...
          background: url(${fresmartImg}) center/cover no-repeat;
      ...
      <div className="container">
        <header>
          <h2 className="mama">Fresh Mart</h2>
          <div className="mj-search">
            <input
              type="text"
              placeholder="Search fresh mart..."
              value={searchText}
      ...
      <div className={`cart ${cartVisible ? "show" : ""}`}>
        ...
        <button className="btn btn-checkout" onClick={goCheckout}>Go to Checkout</button>
