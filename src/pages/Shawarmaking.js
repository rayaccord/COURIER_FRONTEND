...
import shawarma2Img from "../assets/shawarma2.jpg";
...
const App = () => {
  ...
  const restaurantsData = [
    { name: "shawarma - shawarma", category: "shawarma", price: 75, img: shawarmaImg },
    { name: "shawarma - shawarma", category: "yummy shawarma", price: 75, img: shawarma2Img },
    { name: "shawarma - shawarma", category: "yummy shawarma", price: 75, img: shawarma2Img },
    { name: "shawarma - shawarma", category: "shawarma", price: 75, img: shawarmaImg },
    { name: "yummy shawarma", category: "yummy shawarma", price: 75, img: shawarma2Img },
    { name: "shawarma - shawarma", category: "shawarma", price: 75, img: shawarmaImg },
    { name: "yummy shawarma", category: "yummy shawarma", price: 75, img: shawarma2Img },
    { name: "yummy shawarma", category: "yummy shawarma", price: 75, img: shawarma2Img },
    { name: "yummy shawarma", category: "yummy shawarma", price: 75, img: shawarma2Img },
  ...
  return (
    <div>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; font-family:"Inter",Arial,sans-serif; }
        ...
        header {
          ...
          background: url(${shawarmaImg}) center/cover no-repeat;
      ...
      <div className="container">
        <header>
          <h2 className="mama">SHAWARMA KING</h2>
        ...
        <div className="categories">
          {["all", "shawarma", "yummy shawarma"].map((cat) => (
            <div
              key={cat}
      ...
      <footer className="footer">
        <div className="container">
          <p>&copy; {new Date().getFullYear()} SHAWARMA KING. All rights reserved.</p>
