...
import wristWatch from "../assets/watch1.jpg";
import chainImg from "../assets/chain.png";
import earringImg from "../assets/earring.jpg";
import headerBg from "../assets/wristwatch.jpg";
...
const JeweryApp = () => {
  ...
  const items = [
    { name: "Wrist Watch", desc: "Wrist Watch", category: "watch", price: 75, img: wristWatch },
    { name: "Neck chain", desc: "Neck chain", category: "chain", price: 75, img: chainImg },
    { name: "Ear ring", desc: "Ear ring", category: "earring", price: 75, img: earringImg },
    { name: "Wrist Watch", desc: "Wrist Watch", category: "watch", price: 75, img: wristWatch },
    { name: "Neck chain", desc: "Neck chain", category: "chain", price: 75, img: chainImg },
    { name: "Wrist Watch", desc: "Wrist Watch", category: "watch", price: 75, img: wristWatch },
    { name: "Neck chain", desc: "Neck chain", category: "chain", price: 75, img: chainImg },
  ...
  const categories = [
    { label: "All", value: "all" },
    { label: "Wrist Watch", value: "watch" },
    { label: "Neck chain", value: "chain" },
    { label: "Ear ring", value: "earring" },
  ];
  ...
  return (
    <>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; font-family:"Inter",Arial,sans-serif; }
        ...
        @media (max-width:768px) {
          ...
          .cart { right:12px; bottom:12px; width:220px; }
          .mama { font-size:26px; }
        }
      ...
      <div className="container">
        {/* Header */}
        <header>
          <h2 className="mama">Jewery</h2>
          <div className="mj-search">
            <input
              type="text"
              placeholder="Search jewery..."
              value={searchText}
      ...
      <div className={`cart ${cartVisible ? "show" : ""}`} id="cart">
        ...
        <button className="btn btn-checkout" onClick={goCheckout} style={{ marginTop: 8 }}>
          Checkout
        </button>
        <button className="btn btn-clear" onClick={clearCart} style={{ marginTop: 8 }}>
          Clear Cart
        </button>
      </div>
